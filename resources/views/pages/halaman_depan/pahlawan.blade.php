    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-sm-6 offset-sm-3">
                <h3 >Pahlawan</h3>
                <p>Kita adalah bangsa pejuang. Kita punya darah patriot yang mengalir di badan kita, yang tidak mudah menyerah dan yang tidak mudah mengatakan 'saya kalah'..</p>
            </div>
        </div>
