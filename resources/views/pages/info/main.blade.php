    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="card p-4">
                ...
                <button data-id_info="{{ $row->id_info }}" class="btn btn-danger hapus-info"><i
                        class="fas fa-trash"></i>
                    Delete</button>
                    <a href="{{ URL::to('/admin/info/' . $row->id_kategori . '/' . $row->id_info) }}" class="btn btn-warning mt-3"><i
                        class="fas fa-pen"></i>
                    Edit</a>
                    <a href="{{ URL::to('/admin/sub_info/' . $row->id_info ) }}" class="btn btn-primary mt-3"><i
                        class="fas fa-list"></i>
                    Sub info</a>
            </div>
        </div>
