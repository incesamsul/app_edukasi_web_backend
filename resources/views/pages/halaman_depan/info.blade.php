...
<script>
    ...
    $('.btn-selengkapnya').on('click',function(){
        ...
        console.log(detail.deskripsi)
        $('#detailModalLabel').html(detail.judul_info);
        $('#judulInfoLabel').html(detail.judul_info);
        $('#deskripsiInfoLabel').html(detail.deskripsi);
        $('#gambar1').attr('src','/data/data_upload/info/' + removeSpace(detail.judul_info) + '/foto1/' + detail.foto1);
        $('#gambar2').attr('src','/data/data_upload/info/' + removeSpace(detail.judul_info) + '/foto2/' + detail.foto2);
        $('#gambar3').attr('src','/data/data_upload/info/' + removeSpace(detail.judul_info) + '/foto3/' + detail.foto3);
