...
<head>
    ...
    <title>Aplikasi edukasi sekolah</title>
    <!-- Bootstrap CDN-->
        ...
        <div class="container-fluid login-wrapper ">
            <div class="row login-row">
                <div class="col-md-4 login-sec ">
                    <h2 class="text-center mt-5">Aplikasi edukasi SMKN3 PANGKEP</h2>
                    @if (session('fail'))
                    ...
                    <div class="copy-text">Copyright © 2021 ♦ app edukasi.</div>
                </div>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img class="d-block img-fluid" src="{{ asset('img/svg/ilustration/history.svg') }}"
