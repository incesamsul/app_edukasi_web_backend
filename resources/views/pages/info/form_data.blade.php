<form id="formInfo" action="{{ URL::to('/admin/simpan_info') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
        <label for="judul">judul</label>
        <input type="hidden" name="id_info" value="{{ $edit ? $edit->id_info :'' }}">
        <input type="hidden" name="kategori" class="form-control" value="{{ $id_kategori }}">
        <input type="text" name="judul" class="form-control" id="judul" value="{{ $edit ? $edit->judul_info : '' }}">
