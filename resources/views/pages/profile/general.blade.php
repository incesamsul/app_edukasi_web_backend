            ...
            <div class="card-body">
                <div class="container">
                    <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="media">
                            <div class="media-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td class="bg-soft-primary">golongan</td>
                                        <td>{{ $profile->golongan }}</td>
                                    </tr>
                                    <tr>
                                        <td class="bg-soft-primary">Jabatan</td>
                        ...
                        <li class="media">
                            <div class="media-body">
                                <a href="" class="btn bg-main text-white btn-lg btn-block btn-icon-split" data-toggle="modal" data-target="#editData">
                                    <i class="fas fa-users"></i> Ubah Data
                                </a>
